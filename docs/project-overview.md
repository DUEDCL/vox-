...
| Python 测试 | **649 passed, 3 skipped**（全量 AUTO；事件 sink 专项 **123 passed**、DesktopBridge 专项 **33 passed**、采集专项 **36 passed**；无真实设备） |
...
| 测试 | `tests/*.py` + `tests/integration/` | — | 652 collected（649 passed + 3 skipped）；DesktopBridge 专项 33 passed，采集专项覆盖启动回滚、回调隔离、ASR/KWS 恢复与幂等停止，见 [测试文档](testing.md) |
