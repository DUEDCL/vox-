...
(function () {
  ...
  var TMP = 'D:\\program\\vioce-wake\\.claude\\worktrees\\ui-d91f92\\.vox-ref-ae\\scan1.aep';
  var LOG = 'D:\\program\\vioce-wake\\.claude\\worktrees\\ui-d91f92\\.vox-scan1.txt';
  var SRC = '预合成 1';        // 最终合成（含全部后期），30s
  ...
  if (src === null) { W(SRC + ' not found'); }
    ...
    var scan = pr.items.addComp('scan1', src.width, src.height, 1, OUT_DUR, src.frameRate);
